...
class Trainer(BaseTrainer):
    ...
    def update(self,  cfg, input_points, near_net, far_net, epoch, step,*args, **kwargs):
        ...
        loss = 1000*factor[0]*(u_zero_squared.mean()) + factor[1]*normal_alignment.mean() + factor[2]* bd_loss + 0.00001*(singular_hess.mean() + 0.0000001*L2_hess.mean())#+ 3*sing_fac*singular_hess.mean()
